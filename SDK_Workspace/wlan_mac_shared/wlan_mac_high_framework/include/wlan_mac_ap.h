...
// Allow testing to measure performance of interface between WARP and PC.
#define WARP_PC_INTERFACE_TEST
...
#define UART_SEND_ETHERNET_PACKET	   5
...
void send_management_to_wifient_to_wifi(dl_list* checkout, packet_bd*	tx_queue, u16 tx_length, u8 retry);
